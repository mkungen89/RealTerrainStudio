...
export default function SignupPage() {
  ...
  // Get plan and interval from URL params (from pricing page)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (selectedPlan && data.user) {
        router.push(`/pricing?plan=${selectedPlan}&interval=${selectedInterval}`)
      } else {
    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center bg-slate-50 px-4 py-12">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>
            Get started with RealTerrain Studio today
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {selectedPlan && (
              <div className="rounded-md bg-primary-50 p-3 text-sm text-primary-700">
                You'll be signed up for the <strong>{selectedPlan}</strong> plan
              </div>
            )}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-md border border-slate-300 py-2 pl-10 pr-4 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500"
                />
              </div>
            </div>
